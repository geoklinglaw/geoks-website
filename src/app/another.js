...
//                 <div className="regularpages bg-bookmark-black">
...
//                     <FullpageSection className="hero flex justify-center items-center h-screen">
//                         <ScrollToTop />
...
//                     <FullpageSection className="hero ">
